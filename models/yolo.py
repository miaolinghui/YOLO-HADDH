...
from nn.vit.Vit import MbViTV3
import torch
import torch.nn as nn
from models.common import PartialConv, GSConv, EDC_SPPF
from models.Addmodules.DCNv4 import C3DCN
from models.Addmodules.starnet import C3_Starnet,C3_Starnets,C3_Starnetss
from models.Addmodules.MobileVIT import C3_MobileViTs,C3_MobileViT
from models.Addmodules.Dysample import Dy_Sample
from models.DCNv4_op.DCNv4.modules.dcnv4 import DCNV4_YoLo,DCNv4
...
class Decoupled_Detect(nn.Module):
    ...
    def __init__(self, nc=80, anchors=(), ch=(), inplace=True):  # detection layer
        ...
        self.anchor_grid = [torch.empty(0) for _ in range(self.nl)]  # init anchor grid
        self.register_buffer('anchors', torch.tensor(anchors).float().view(self.nl, -1, 2))  # shape(nl,na,2)
        self.m_stem = nn.ModuleList(nn.Sequential(Conv(x, x, 1),DCNv4(x)) for x in ch)  # stem conv
        # Replace Conv with PartialConv for classification
